---
title: "TGI Spinal Analysis Code Experiment 2"
author: "A.G. Mitchell"
date: "2022-12-02"
output: html_document
---

DATA ANALYSIS SCRIPT FOR TGI-SPINE EXPERIMENT 2
...
ggsave(here::here("figures", "E2_H2_allDat.png"), plot = h2_plot, 
       device = NULL, width = 9, height = 5, dpi = 600)
```

# make box plots for poster
```{r}
# cold 
...
ggsave(here::here("figures", "E2_posterPlot.png"), plot = p_plot, 
...
ggsave(here::here("figures", "E2_marginalEffects.png"), plot = plot_eff, 
       device = NULL, width = 9, height = 5, dpi = 600)
```
...
ggsave(here::here("figures", "E2_correlations.png"), plot = corr_plot, 
       device = NULL, width = 9, height = 5, dpi = 600)
```
