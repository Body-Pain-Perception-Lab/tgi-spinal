...
plot2 = function(include_zero = T){
  ...
  experiment1_h2 = make_plot2(vas_h2_diff_exp1,h2_diff_sum_exp1, title = "Reference: Cold Thermode")+plot_annotation(tag_levels = list("A","B"))
  ...
  experiment2_h2 = make_plot2(vas_h2_diff_exp2,h2_diff_sum_exp2, title = "Reference: Warm Thermode")+plot_annotation(tag_levels = list(c("C","D")))
