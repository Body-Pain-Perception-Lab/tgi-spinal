...
vars.instructions.StartVas = ['First, please rate the most intense burning experience that you are feeling.\n' ...
    'When instructed by the experimenter, press a key to start rating'];
