...
vars.instructions.StartScreen = ['For each trial, you will experience thermal stimulation on your skin.\n\n' ...
    'First, you should rate the most intense burning sensation you are experiencing from\n' ...
    'either probe A or B the beginning of stimulation on a scale of 0 - 100.\n\n' ...
    'After this you will then be asked how much probe A or B\n' ...
    'is BURNING, feels WARM or feels COLD on a scale of 0 - 100.\n\n' ...
    'In this scale 0 represents no burning/warm/cold sensation,\n' ...
...
vars.instructions.Question = {'At the moment, how much is the stimulus BURNING?',...
                               ...
                               'At the moment, what is the strongest BURNING sensation you are feeling?'}; 
                           
vars.instructions.QuestionCode = [1 2 3 4]; % 1 - burning, 2 - warm, 3 - cold
