...
a_dr_tgi_cold <- rnorm(trialN, mean=sample(5:40,1), sd=15)
a_pc_tgi_cold <- rnorm(trialN, mean=sample(5:45,1), sd=15)
...
a_pc_tgi_warm <- rnorm(trialN, mean=sample(10:80,1), sd=15)
...
# Burning ratings: simulation
 ...
 a_dr_tgi_burn <- rnorm(trialN, mean=sample(5:40,1), sd=15)
