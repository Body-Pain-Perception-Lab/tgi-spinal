...
# then adding procedure as a fiexed effect
model.cold2 <- lmer(rating ~ manipulation + condition + cold_location +
                     (1|ID) + (1|procedure), 
                   data = df_sum[df_sum$VAS == 'cold' ,])
# then modelling slope of the subjects
model.cold3 <- lmer(rating ~ manipulation + condition + cold_location +
                     (1+manipulation|ID) + (1|procedure), 
                   data = df_sum[df_sum$VAS == 'cold' ,])

# summarise all 3 models
modelsummary(list(model.cold, model.cold2, model.cold3),
             gof_map = gof_stuff)
```
