...
```
Need to change this and create two cold models - one with zero inflated and one without
Also need to check Bayesian
- Check out Jesper's code
...
model.cold = glmmTMB::glmmTMB(rating ~ manipulation + condition + cold_location + (1|ID),
