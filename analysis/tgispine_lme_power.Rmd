...
tgi_effect <- fixef(model.cold.ex)["manipulationTGI"]
cond_effect <- fixef(model.cold.ex)["conditionwithin"]
cold_loc_effect <- fixef(model.cold.ex)["cold_locationprox_caud"]

# power analysis - using smallest effect size
fixef(model.cold.ex)["manipulationTGI"] <- cold_loc_effect
