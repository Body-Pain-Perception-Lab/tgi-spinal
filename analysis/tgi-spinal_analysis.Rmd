...
if (!require("pacman")) install.packages("pacman")
  pacman::p_load(boot, broom, broom.mixed, brms, caret, corrplot, DHARMa, 
...
df_corr <- df_corr %>% 
  ...
  rename(NonTGI_cold = VAScold_CNT,
         TGI_cold = VAScold_TGI,
         NonTGI_warm = VASwarm_CNT,
         TGI_warm = VASwarm_TGI,
         NonTGI_burn = VASburn_CNT,
         TGI_burn = VASburn_TGI)
...
# correlate
cormat <- hetcor(df_corr, type = 'pearson')$correlations
cormat
...
corrplot(cormat, method="circle", addrect = 0,
         title = "VAS rating correlation matrix", mar = c(0,0,1,0), 
         tl.cex=0.9) 
```
